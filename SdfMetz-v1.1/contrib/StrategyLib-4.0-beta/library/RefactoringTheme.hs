...
generic refactoring functionality. See the paper "Towards Generic
Refactoring" by Ralf Laemmel. See also examples/generic-refactoring.
...
--- Removal of an unused abstraction ------------------------------------------
...
--- Insertion of a new abstraction --------------------------------------------
...
-- The generic extract (say fold) function
