...
instance Typeable Alias where
    typeOf x = mkTyConApp _tc_AliasTc [ ]
...
instance Typeable Aliases where
    typeOf x = mkTyConApp _tc_AliasesTc [ ]
...
instance Typeable Lookahead where
    typeOf x = mkTyConApp _tc_LookaheadTc [ ]
...
instance Typeable Lookaheads where
    typeOf x = mkTyConApp _tc_LookaheadsTc [ ]
...
instance Typeable Restriction where
    typeOf x = mkTyConApp _tc_RestrictionTc [ ]
...
instance Typeable Restrictions where
    typeOf x = mkTyConApp _tc_RestrictionsTc [ ]
...
instance Typeable Attribute where
    typeOf x = mkTyConApp _tc_AttributeTc [ ]
...
instance Typeable OptExp where
    typeOf x = mkTyConApp _tc_OptExpTc [ ]
...
instance Typeable RealCon where
    typeOf x = mkTyConApp _tc_RealConTc [ ]
...
instance Typeable AFun where
    typeOf x = mkTyConApp _tc_AFunTc [ ]
...
instance Typeable A_Term where
    typeOf x = mkTyConApp _tc_A_TermTc [ ]
...
instance Typeable Production where
    typeOf x = mkTyConApp _tc_ProductionTc [ ]
...
instance Typeable Character where
    typeOf x = mkTyConApp _tc_CharacterTc [ ]
...
instance Typeable CharRange where
    typeOf x = mkTyConApp _tc_CharRangeTc [ ]
...
instance Typeable CharRanges where
    typeOf x = mkTyConApp _tc_CharRangesTc [ ]
...
instance Typeable OptCharRanges where
    typeOf x = mkTyConApp _tc_OptCharRangesTc [ ]
...
instance Typeable CharClass where
    typeOf x = mkTyConApp _tc_CharClassTc [ ]
...
instance Typeable Associativity where
    typeOf x = mkTyConApp _tc_AssociativityTc [ ]
...
instance Typeable Group where
    typeOf x = mkTyConApp _tc_GroupTc [ ]
...
instance Typeable Priority where
    typeOf x = mkTyConApp _tc_PriorityTc [ ]
...
instance Typeable Priorities where
    typeOf x = mkTyConApp _tc_PrioritiesTc [ ]
...
instance Typeable IntCon where
    typeOf x = mkTyConApp _tc_IntConTc [ ]
...
instance Typeable Renamings where
    typeOf x = mkTyConApp _tc_RenamingsTc [ ]
...
instance Typeable Renaming where
    typeOf x = mkTyConApp _tc_RenamingTc [ ]
...
instance Typeable Definition where
    typeOf x = mkTyConApp _tc_DefinitionTc [ ]
...
instance Typeable Section where
    typeOf x = mkTyConApp _tc_SectionTc [ ]
...
instance Typeable Sections where
    typeOf x = mkTyConApp _tc_SectionsTc [ ]
...
instance Typeable ModuleName where
    typeOf x = mkTyConApp _tc_ModuleNameTc [ ]
...
instance Typeable ImpSection where
    typeOf x = mkTyConApp _tc_ImpSectionTc [ ]
...
instance Typeable Imports where
    typeOf x = mkTyConApp _tc_ImportsTc [ ]
...
instance Typeable Import where
    typeOf x = mkTyConApp _tc_ImportTc [ ]
...
instance Typeable Symbols where
    typeOf x = mkTyConApp _tc_SymbolsTc [ ]
...
instance Typeable Attributes where
    typeOf x = mkTyConApp _tc_AttributesTc [ ]
...
instance Typeable Productions where
    typeOf x = mkTyConApp _tc_ProductionsTc [ ]
